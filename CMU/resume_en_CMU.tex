...
\section{Skills Summary}
  ...
  Also keen on building personal projects including games(using Pygame), toy computer emulator and a 4 bit computer from scratch.}
    ...
    \resumeSubItem{Thermal fluid analysis}
      { 5+ years experience in a next-generation mechanical product R\&D team. 
      \begin{itemize}
      \item Developed component level thermal fluid models (using Python, Fortran and opensource C++ code (OpenFOAM)) to assist product design and accelerated development cycle. 
