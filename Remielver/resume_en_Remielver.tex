...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Thermal/Fluid dynamic analysis}
      ...
      heat exchanger by Ansys Fluent and Opensource CFD library.}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Development of pneumatic drive high capacity Gifford-McMahon cryocooler}
        {  \begin{itemize}
           ...
           \item {Carried out numerical thermal/mechanical analysis of the key components and proposed the prototyping strategies. }
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        {  
           \begin{itemize}
           \item{Carried out detailed analysis of previous cryocooler products and based on that, designed key components (regenerator etc.) of a new, highly compact Gifford-McMahon cryocooler
           which can achieve 2K on its second stage.}
        ...
        {
           \begin{itemize}
           \item{Carried out conceptual design and detailed analysis of a next generation high capacity Gifford-McMahon cryocooler.}
           \item {Built test facilities to assist the prototyping of innovative design concepts.}
           \item {Published 2 papers in international cryogenic conference based on this work.}
           \end{itemize}
        }
      \resumeItemListEnd
