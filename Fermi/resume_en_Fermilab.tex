...
\section{Skills Summary}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Thermo-fluid analysis}
      { 5+ years experience in a next-generation cryocooler product R\&D team. 
      \begin{itemize}
      \item Developed component level thermo-fluid models (using Python, Fortran and opensource C++ code (OpenFOAM)) to assist product design and accelerated development cycle. 
      \item Strong analysis skills in Ansys Mechanical / Fluent to facilitate and accelerate product prototyping.
    ...
    \resumeSubItem{Mechnical design}
      ...
      \begin{itemize}
        ...
        \item 2+ years experience in Solidworks. CSWA certificated by Solidworks.
        \item Designed various components to facilitate cryocooler testing including vacuum chamber, pressure measurement fixtures, etc.
      \end{itemize}
      }

    \resumeSubItem{Cryogenic measurement}
      {Carried out testing and prototyping of products involving cryogenic temperature.
       \begin{itemize}
         \item Measurement and error analysis of temperature down to 2-4 K. Hands-on experiences in reducing signal noise in measurement system.
         \item Pressure measurement at both room and cryogenic temperature. 
       \end{itemize}
      Developed customized data processing / visualization programs to provide insight for product improvement.}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Engineering in Graduate School of Mechanical Engineering}{Oct. 2010 -- Mar. 2013}
      
      Thesis : Study of heat transfer and fluid flow of bubbles in a microchannel; Advisor : Shigenao Maruyama

    \resumeSubheading
      {Shanghai Jiaotong University}{Shanghai, China}
      {Bachelor of Engineering in School of Mechanical Engineering}{Sep. 2006 -- Jun. 2010}
...
\resumeSubHeadingListStart
  ...
  \resumeSubItem{English}{Professional efficiency}
  \resumeSubItem{Japanese}{Professional efficiency}
  \resumeSubItem{German}{Intermediate efficiency}
\resumeSubHeadingListEnd
