...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://github.com/houkensjtu}{\Large Qian Bao}} & Email : \href{mailto:houkensjtu@gmail.com}{qbao@seas.upenn.edu}\\
...
\section{Skills Summary}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Thermal fluid analysis}
      { General knowledge in fluid dynamics, heat transfer and CFD. 6+ years experience in a next-generation mechanical product R\&D team. 
      \begin{itemize}
    ...
    \resumeSubItem{Computer science related}
      ...
      \end{itemize}
      5+ years experience in Linux operating system and have familiarity with shell/Git/script languages.
      }
...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Engineering in Scientific Computing;  GPA: --/4.0}{Sep. 2021 -- May. 2023 (Expected)}
    \resumeSubheading
      {Tohoku University}{Sendai, Japan}
      {Master of Engineering in Graduate School of Mechanical Engineering;  GPA: 3.8/4.0}{Oct. 2010 -- Mar. 2013}
    \resumeSubheading
...
%----------Publications-------
\section{Publication}
1.Developer Story: Incompressible Fluid Simulation using Taichi (based on FVM and SIMPLE schemes), Taichicon02 Conference, 2021
  
2.Experimental Investigation of Compact 2 K GM Cryocoolers, Physics Procedia, Volume 67, Pages 428-433, ISSN 1875-3892,
...
3.Development of a compact 2K GM cryocooler, Cryogenic engineering (Japanese), Vol.50 (2015) No.3 p. 125-131
...
5.Development status of a high cooling capacity single stage GM cryocooler,
Cryocooler 19,
pp. 291-297,
(International Conference of cryocoolers ,ICC19: San Diego, CA, USA, June 20-23, 2016)

6.Development of a pneumatic GM cryocooler with dual-displacer (Oral presentation, International workshop on cooling of HTS-Applications, IWC-HTS, Karlsruhe, Germany, September 13-15, 2017)
